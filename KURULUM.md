...
- Projede `site: 'https://arizakodlari.com'` varsa, yayında kullandığın domain’e göre `astro.config.mjs` içindeki `site` ve `src/lib/seo.ts` içindeki `SITE_URL` değerlerini güncelle.  
